...
void ACAIController::OnPossess(APawn* NewPawn)
{
	...
	IGenericTeamAgentInterface* PawnAsTeamInterface = Cast<IGenericTeamAgentInterface>(NewPawn);
...
void ACAIController::ForgetDeadActor(AActor* ActorToForget)
{
